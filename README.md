...
### - 最新版本：[VRChatEasyTrans-1.0.3](https://github.com/Rosa-11/VRChatEasyTrans/releases/download/1.0.3/VRChatEasyTrans-1.0.3.zip)
### - 之前的版本：https://github.com/Rosa-11/VRChatEasyTrans/releases
...
- 目标操作系统: Windows 10/11, macOS 10.14+
- 编译器: C++17 兼容编译器
- 依赖: Qt5.0+, CMake 3.16+
...
TODO: 继续优化延迟与流式接口，集成其他服务商的API


# 🤝 参与贡献

本项目欢迎各种形式的贡献！
如果您编写了使用其他大模型的API接口的语音识别或翻译模块、有其他优化的思路/方案/代码，欢迎PR~
